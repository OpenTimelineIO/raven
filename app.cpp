...
bool LoadFonts(const std::string &resourcePath) {
  ...
  gIconFont =
      io.Fonts->AddFontFromFileTTF(path.c_str(), 16.0f, NULL, icon_fa_ranges);
#endif
...
void ApplyAppStyle() {
  ...
  /*
    ...
    ImVec4(0.00f, 1.00f, 1.00f, 1.00f); colors[ImGuiCol_TextDisabled] =
    ImVec4(0.00f, 0.40f, 0.41f, 1.00f); colors[ImGuiCol_WindowBg] =
    ImVec4(0.00f, 0.00f, 0.00f, 1.00f); colors[ImGuiCol_ChildBg] = ImVec4(0.00f,
    0.00f, 0.00f, 0.00f); colors[ImGuiCol_PopupBg]                =
    ImVec4(0.08f, 0.08f, 0.08f, 0.94f); colors[ImGuiCol_Border] =
    ImVec4(0.00f, 1.00f, 1.00f, 0.65f); colors[ImGuiCol_BorderShadow] =
    ImVec4(0.00f, 0.00f, 0.00f, 0.00f); colors[ImGuiCol_FrameBg] = ImVec4(0.44f,
    0.80f, 0.80f, 0.18f); colors[ImGuiCol_FrameBgHovered]         =
    ImVec4(0.44f, 0.80f, 0.80f, 0.27f); colors[ImGuiCol_FrameBgActive] =
    ImVec4(0.44f, 0.81f, 0.86f, 0.66f); colors[ImGuiCol_TitleBg] = ImVec4(0.14f,
    0.18f, 0.21f, 0.78f); colors[ImGuiCol_TitleBgActive]          =
    ImVec4(0.00f, 0.54f, 0.55f, 0.78f); colors[ImGuiCol_TitleBgCollapsed] =
    ImVec4(0.00f, 0.00f, 0.00f, 0.78f); colors[ImGuiCol_MenuBarBg] =
    ImVec4(0.00f, 0.00f, 0.00f, 0.20f); colors[ImGuiCol_ScrollbarBg] =
    ImVec4(0.22f, 0.29f, 0.30f, 0.71f); colors[ImGuiCol_ScrollbarGrab] =
    ImVec4(0.00f, 1.00f, 1.00f, 0.44f); colors[ImGuiCol_ScrollbarGrabHovered] =
    ImVec4(0.00f, 1.00f, 1.00f, 0.74f); colors[ImGuiCol_ScrollbarGrabActive] =
    ImVec4(0.80f, 0.99f, 0.99f, 1.00f); colors[ImGuiCol_CheckMark] =
    ImVec4(0.00f, 1.00f, 1.00f, 0.68f); colors[ImGuiCol_SliderGrab] =
    ImVec4(0.00f, 1.00f, 1.00f, 0.36f); colors[ImGuiCol_SliderGrabActive] =
    ImVec4(0.80f, 0.99f, 0.99f, 1.00f); colors[ImGuiCol_Button] = ImVec4(0.00f,
    0.65f, 0.65f, 0.46f); colors[ImGuiCol_ButtonHovered]          =
    ImVec4(0.01f, 1.00f, 1.00f, 0.43f); colors[ImGuiCol_ButtonActive] =
    ImVec4(0.80f, 0.99f, 0.99f, 1.00f); colors[ImGuiCol_Header] =
    ImVec4(0.00f, 1.00f, 1.00f, 0.33f); colors[ImGuiCol_HeaderHovered] =
    ImVec4(0.00f, 1.00f, 1.00f, 0.42f); colors[ImGuiCol_HeaderActive] =
    ImVec4(1.00f, 1.00f, 1.00f, 0.54f); colors[ImGuiCol_Separator] =
    ImVec4(0.43f, 0.43f, 0.50f, 0.50f); colors[ImGuiCol_SeparatorHovered] =
    ImVec4(0.10f, 0.40f, 0.75f, 0.78f); colors[ImGuiCol_SeparatorActive] =
    ImVec4(0.10f, 0.40f, 0.75f, 1.00f); colors[ImGuiCol_ResizeGrip] =
    ImVec4(0.00f, 1.00f, 1.00f, 0.54f); colors[ImGuiCol_ResizeGripHovered] =
    ImVec4(0.00f, 1.00f, 1.00f, 0.74f); colors[ImGuiCol_ResizeGripActive] =
    ImVec4(0.80f, 0.99f, 0.99f, 1.00f); colors[ImGuiCol_Tab] = ImVec4(0.12f,
    0.31f, 0.31f, 1.00f); colors[ImGuiCol_TabHovered]             =
    ImVec4(0.80f, 0.99f, 0.99f, 1.00f); colors[ImGuiCol_TabActive] =
    ImVec4(0.00f, 0.62f, 0.62f, 1.00f); colors[ImGuiCol_TabUnfocused] =
    ImVec4(0.08f, 0.15f, 0.15f, 1.00f); colors[ImGuiCol_TabUnfocusedActive] =
    ImVec4(0.14f, 0.43f, 0.43f, 1.00f); colors[ImGuiCol_DockingPreview] =
    ImVec4(0.80f, 0.99f, 0.99f, 1.00f); colors[ImGuiCol_DockingEmptyBg] =
    ImVec4(0.20f, 0.20f, 0.20f, 1.00f); colors[ImGuiCol_PlotLines] =
    ImVec4(0.80f, 0.99f, 0.99f, 1.00f); colors[ImGuiCol_PlotLinesHovered] =
    ImVec4(0.00f, 1.00f, 1.00f, 1.00f); colors[ImGuiCol_PlotHistogram] =
    ImVec4(0.80f, 0.99f, 0.99f, 1.00f); colors[ImGuiCol_PlotHistogramHovered] =
    ImVec4(0.00f, 1.00f, 1.00f, 1.00f); colors[ImGuiCol_TextSelectedBg] =
    ImVec4(0.00f, 1.00f, 1.00f, 0.22f); colors[ImGuiCol_DragDropTarget] =
    ImVec4(1.00f, 1.00f, 0.00f, 0.90f); colors[ImGuiCol_NavHighlight] =
    ImVec4(0.94f, 0.98f, 0.26f, 1.00f); colors[ImGuiCol_NavWindowingHighlight]
...
void LoadFile(std::string path) {
  ...
  if (!timeline || otio::is_error(error_status)) {
    Message("Error loading \"%s\": %s", path.c_str(),
  ...
  Message("Loaded \"%s\" in %.3f seconds", timeline->name().c_str(),
          elapsed_seconds);
}
...
void SaveFile(std::string path) {
  ...
  if (!success || otio::is_error(error_status)) {
    Message("Error saving \"%s\": %s", path.c_str(),
            otio_error_string(error_status).c_str());
    return;
  }
  ...
  std::chrono::duration<double> elapsed = (end - start);
  double elapsed_seconds = elapsed.count();
  Message("Saved \"%s\" in %.3f seconds", timeline->name().c_str(),
          elapsed_seconds);
}
...
ImU32 ImLerpColors(ImU32 col_a, ImU32 col_b, float t) {
  ...
  int a = ImLerp((int)(col_a >> IM_COL32_A_SHIFT) & 0xFF,
                 (int)(col_b >> IM_COL32_A_SHIFT) & 0xFF, t);
...
void MainGui() {
  ...
  auto filename =
      appState.file_path.substr(appState.file_path.find_last_of("/\\") + 1);
  if (filename != "") {
    snprintf(window_title, sizeof(window_title), "%s - %s%s", app_name,
             filename.c_str(), window_id);
  } else {
  ...
  if (ImGui::DockBuilderGetNode(dockspace_id) == NULL) {
    ...
    ImGuiID dock_main_id =
        dockspace_id; // This variable will track the document node, however we
...
void DrawMenu() {
  if (ImGui::BeginMenuBar()) {
    ...
    if (ImGui::BeginMenu("View")) {
      bool showTimecodeOnClips =
          appState.track_height >= appState.default_track_height * 2;
...
void DrawToolbar(ImVec2 button_size) {
  ...
  for (int i = 0; i < AppThemeCol_COUNT; i++) {
    ...
    if (ImGui::ColorEdit4(AppThemeColor_Names[i], &col4f.x,
...
void SeekPlayhead(double seconds) {
  ...
  appState.playhead =
      otio::RationalTime::from_seconds(seconds, appState.playhead.rate());
  if (appState.snap_to_frames) {
    SnapPlayhead();
  }
}
...
void SnapPlayhead() {
  appState.playhead = otio::RationalTime::from_frames(
      appState.playhead.to_frames(), appState.playhead.rate());
}
...
void FitZoomWholeTimeline() {
  appState.scale =
      appState.timeline_width / appState.timeline->duration().to_seconds();
}
